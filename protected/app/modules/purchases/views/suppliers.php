<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
    <h1><?php echo lang('supplier_list_heading'); ?></h1>
    <span class="uk-text-small"><?php echo lang('supplier_list_subheading'); ?></span>
</div>
<div id="page_content_inner">
    <div class="md-card">
        <div class="md-card-content">
            <div class="uk-overflow-container uk-margin-bottom">
                <table class="uk-table uk-table-align-vertical uk-table-hover uk-table-nowrap tablesorter tablesorter-altair" id="table" data-url="<?php echo site_url('purchases/suppliers/get_list'); ?>">
                    <thead>
                        <tr>
...
<div class="uk-modal" id="modal-form">
    <div class="uk-modal-dialog">
        ...
        <form class="uk-form-stacked" id="form" action="<?php echo site_url('purchases/suppliers/save'); ?>" method="post">
            <input type="hidden" id="save_method" name="save_method">
            <input type="hidden" id="id" name="id">
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-1">
                    <div class="parsley-row">
                        <label for="name"><?php echo lang('supplier_name_label'); ?></label>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-1">
                    <div class="parsley-row">
                        <label for="email"><?php echo lang('supplier_email_label'); ?></label>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-1">
                    <div class="parsley-row">
                        <label for="address"><?php echo lang('supplier_address_label'); ?></label>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-3">
                    <div class="parsley-row">
                        <label for="phone"><?php echo lang('supplier_phone_label'); ?></label>
                        <input type="text" name="phone" id="phone" required class="md-input" />
                    </div>
                </div>
                <div class="uk-width-medium-1-3">
                    <div class="parsley-row">
                        <label for="city"><?php echo lang('supplier_city_label'); ?></label>
                        <input type="text" name="city" id="city" required class="md-input" />
                    </div>
                </div>
                <div class="uk-width-medium-1-3">
                    <div class="parsley-row">
                        <label for="postcode"><?php echo lang('supplier_postcode_label'); ?></label>
