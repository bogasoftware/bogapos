<div id="page_content_inner">
    <form id="form" action="<?php echo site_url('sales/save'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-2">
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-1-2">
                                <div class="uk-form-row">
                                    <label for="note"><?php echo lang('sale_note_label'); ?></label>
                            ...
                            <div class="uk-width-1-2">
                                <div class="uk-form-row">
                                    ...
                                    <label for="shipping_check" class="inline-label"><?php echo lang('sale_delivery_label'); ?></label>
                                </div>
                                <div id="shipping-address-form" style="display: none">
                                    ...
                                    <div class="uk-form-row uk-margin-top">
                                        ...
                                        <input type="text" name="shipping_recipient" id="shipping_recipient" class="md-input"/>
                                    </div>
                                    <div class="uk-form-row uk-margin-top">
                                        <label for="shipping_address"><?php echo lang('sale_delivery_address_label'); ?></label>
                                        <textarea name="shipping_address" id="shipping_address" class="md-input"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-1-2">
                                <div class="uk-form-row uk-form">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="subtotal"><?php echo lang('sale_subtotal_label'); ?></label>
                                ...
                                <div class="uk-form-row uk-form uk-margin-top">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="discount"><?php echo lang('sale_discount_label'); ?></label>
                                        <div class="uk-width-6-10">
                                ...
                                <div class="uk-form-row uk-form uk-margin-top" id="shipping-form"  style="display: none">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="shipping"><?php echo lang('sale_shipping_cost_label'); ?></label>
                                        <div class="uk-width-6-10">
                            ...
                            <div class="uk-width-1-2">
                                <div class="uk-form-row uk-form">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="total"><?php echo lang('sale_total_label'); ?></label>
                                        <div class="uk-width-6-10">
                                ...
                                <div class="uk-form-row uk-form uk-margin-top">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="cash"><?php echo lang('sale_cash_label'); ?></label>
                                        <div class="uk-width-6-10">
                                ...
                                <div class="uk-form-row uk-form uk-margin-top">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="credit"><?php echo lang('sale_credit_label'); ?></label>
                                        <div class="uk-width-6-10">
                                ...
                                <div class="uk-form-row uk-form uk-margin-top" style="display: none" id="change-form">
                                    <div class="uk-grid">
                                        <label class="uk-width-4-10" for="change"><?php echo lang('sale_change_label'); ?></label>
                                        <div class="uk-width-6-10">
...
<?php if ($data) { ?>
    ...
    <?php } ?>
        localStorage.setItem('sldiscount', data.discount);
        localStorage.setItem('sltax', data.tax);
        localStorage.setItem('slcash', data.cash);
        localStorage.setItem('slnote', data.note);
        localStorage.setItem('slproducts', '<?php echo json_encode($products); ?>');
...
<?php } else { ?>
        localStorage.setItem('slmethod', 'add');
