...
class Reports extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['total_sales'] = $this->sales->total_this_month($this->session->userdata('store')->id);
        $this->data['total_purchase'] = $this->purchase->total_this_month($this->session->userdata('store')->id);
        ...
        $this->data['total_profit_loss'] = $profit_loss->sales - $profit_loss->cost - $profit_loss->shipping_cost;
