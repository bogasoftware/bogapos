<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
    ...
    <h1><?php echo lang('report_profit_loss_recap_heading'); ?></h1>
                ...
                <table class="uk-table uk-table-align-vertical uk-table-hover uk-table-nowrap tablesorter tablesorter-altair" id="table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo lang('report_profit_loss_customer_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_profit_loss_subtotal_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_profit_loss_total_label') . ' ' . lang('report_profit_loss_cost_of_goods_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_profit_loss_gross_profit_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_profit_loss_discount_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_profit_loss_selling_profit_label'); ?></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
