<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
    <div class="heading_actions">
        ...
        <!--<a href="<?php // echo site_url('reports/purchase/detail');    ?>" class="md-btn md-btn-wave waves-effect waves-button">Detail</a>-->
        <a href="<?php echo site_url('reports/purchase/recap'); ?>" class="md-btn md-btn-wave waves-effect waves-button">Rekap</a>
    </div>
    <h1>Pembelian Harian</h1>
