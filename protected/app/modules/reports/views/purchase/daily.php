<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
    ...
    <h1><?php echo lang('report_purchase_daily_heading'); ?></h1>
                ...
                <table class="uk-table uk-table-align-vertical uk-table-hover uk-table-nowrap tablesorter tablesorter-altair" id="table">
                    <thead>
                        <tr>
                            ...
                            <th class="uk-text-right"><?php echo lang('report_purchase_count_transaction_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_purchase_total_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_purchase_total_cash_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_purchase_total_credit_label'); ?></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
