<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
    <div class="heading_actions">
        <a href="<?php echo site_url('reports/sales'); ?>" class="md-btn md-btn-wave waves-effect waves-button"><?php echo lang('report_chart_text'); ?></a>
        <a href="<?php echo site_url('reports/sales/daily'); ?>" class="md-btn md-btn-wave waves-effect waves-button"><?php echo lang('report_daily_text'); ?></a>
    </div>
    <h1><?php echo lang('report_sales_recap_heading'); ?></h1>
                ...
                <div class="uk-width-medium-7-10">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-medium-1-2">
                            ...
                            <input type="text" id="date-end" readonly="" class="md-input" data-uk-datepicker="{format:'<?php echo lang('date_format_uk'); ?>'}" value="<?php echo get_date(date('Y-m-t')); ?>" />
                        </div>
                    </div>
                </div>
        ...
        <div class="md-card-content">
            <div class="uk-overflow-container uk-margin-bottom">
                <table class="uk-table uk-table-align-vertical uk-table-hover uk-table-nowrap tablesorter tablesorter-altair" id="table">
                    <thead>
                        <tr>
                            <th><?php echo lang('report_sales_code_label'); ?></th>
                            <th><?php echo lang('report_sales_date_label'); ?></th>
                            <th><?php echo lang('report_sales_customer_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_subtotal_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_discount_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_tax_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_shipping_cost_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_total_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_cash_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_credit_label'); ?></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
