<div id="page_heading" data-uk-sticky="{ top: 48, media: 960 }">
    <div class="heading_actions">
        ...
        <a href="<?php echo site_url('reports/sales/recap'); ?>" class="md-btn md-btn-wave waves-effect waves-button"><?php echo lang('report_recap_text'); ?></a>
    </div>
    <h1><?php echo lang('report_sales_daily_heading'); ?></h1>
                ...
                <table class="uk-table uk-table-align-vertical uk-table-hover uk-table-nowrap tablesorter tablesorter-altair" id="table">
                    <thead>
                        <tr>
                            ...
                            <th class="uk-text-right"><?php echo lang('report_sales_count_transaction_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_total_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_total_cash_label'); ?></th>
                            <th class="uk-text-right"><?php echo lang('report_sales_total_credit_label'); ?></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
